...
The tromba marina is a bowed monochord (a single-string instrument) from the 15th century . The string rests on a loose bridge that rattles against the body which creates a sound with brass- or trumpet-like qualities. It is played by slightly damping the string with a finger of the non-bowing hand at different locations triggering harmonics of the open string. Unlike most bowed instruments, the tromba marina is bowed closer to the nut, and the pitch-determining finger is closer to the bridge (below the bow).
...
The experiment will be divided in two parts. Firstly you are asked to explore the instrument on your own; take your time and try to find out how the instrument works and how it sounds. When you think you are done, let us know. We will instruct you about the second part.
...
\centering
  \caption{The left Oculus controller with the controls for changing the pitch highlighted. \label{fig:oculusController}}
\end{figure}
